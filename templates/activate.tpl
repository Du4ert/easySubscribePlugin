 ...
 *}
 {include file="frontend/components/header.tpl" pageTitle="plugins.generic.easySubscribe.activate.title"}
 ...
 <div id="main-content" class="page page_editorial_team">
     ...
     <div class="page-header">
         ...
         <h1>{translate key="plugins.generic.easySubscribe.activate.title"}</h1>
     </div>
     {* /Page Title *}
